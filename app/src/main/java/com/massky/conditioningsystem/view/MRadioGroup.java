...
public class MRadioGroup extends GridLayout {
    ...
    private MRadioButton.OnCheckedChangeListener mChildOnCheckedChangeListener;
    ...
    public MRadioGroup(Context context, AttributeSet attrs) {
        ...
        if (value != View.NO_ID) {
            mCheckedId = value;
            Log.e("MINE", "setChecked mCheckedId:" + mCheckedId);
        }
        attributes.recycle();
        init();
    }
    ...
    private class CheckedStateTracker implements MRadioButton.OnCheckedChangeListener {
    ...
    private class PassThroughHierarchyChangeListener implements
        ...
        public void onChildViewAdded(View parent, View child) {
            if (parent == MRadioGroup.this && child instanceof MRadioButton) {
                ...
                ((MRadioButton) child).setOnCheckedChangeWidgetListener(
        ...
        public void onChildViewRemoved(View parent, View child) {
            if (parent == MRadioGroup.this && child instanceof MRadioButton) {
                ((MRadioButton) child).setOnCheckedChangeWidgetListener(null);
            }
            if (mOnHierarchyChangeListener != null) {
